...
export function Dashboard() {
  ...
  useEffect(() => {
    ...
    console.log("Dashboard carregado - MongoDB temporariamente desabilitado");
    setCars([]);
  }, [user]);
    ...
    <Container>
      ...
      {cars.length === 0 && (
        <div className="text-center mt-8">
          ...
          <p className="text-gray-400 text-sm">MongoDB temporariamente desabilitado para teste</p>
        </div>
      )}
    </Container>
  );
